...
class DiagnosisController extends Controller
{
    ...
    public function store(DiagnosisStoreRequest $request): RedirectResponse
    {
        ...
        $diagnosis = $request->user()->diagnoses()->create([
            ...
            'predicted_species_name' => $result->speciesName,
            'predicted_scientific_name' => $result->scientificName,
            'confidence' => $result->confidence,
            'is_plant_confidence' => $result->isPlantConfidence,
    ...
    public function show(Request $request, Diagnosis $diagnosis): Response
    {
        ...
        return Inertia::render('diagnoses/show', [
            'diagnosis' => [
                ...
                'species_name' => $diagnosis->predicted_species_name,
                'scientific_name' => $diagnosis->predicted_scientific_name,
                'confidence' => $diagnosis->confidence,
                'is_plant_confidence' => $diagnosis->is_plant_confidence,
